                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 mb-3">
                  ...
                  <div className="flex flex-col gap-1.5 items-start sm:items-end">
                    ...
                    <div className="flex flex-wrap gap-1.5 items-center sm:justify-end">
                      ...
                      {item.jobType && (
                        <span className="inline-flex items-center px-1.5 py-0.5 bg-slate-100 dark:bg-white/10 text-slate-600 dark:text-slate-300 text-[10px] font-semibold rounded border border-slate-200/50 dark:border-white/5">
                          {item.jobType}
                        </span>
                      )}
                      {item.workMode && (
