      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center space-x-2 mb-4">
              <img src="/favicon.svg" alt="GB" width={36} height={36} className="rounded-xl shadow-lg shadow-primary-500/30" />
              <span className="text-xl font-black text-slate-900 dark:text-white">GAURAV</span>
            </div>
        ...
        <div className="border-t border-slate-200/60 dark:border-white/10 pt-6 text-center">
          <p className="text-sm text-slate-400 dark:text-slate-500 flex items-center justify-center flex-wrap gap-1">
            <span>© {new Date().getFullYear()} Gaurav Borawake. Made with</span>
